...
class AdherenceService {
    ...
    getPatientAnalytics(patientId) {
        const schedules = db_1.db.medicationSchedules.find(s => s.patientId === patientId);
        const records = db_1.db.adherenceRecords.find(r => r.patientId === patientId);
        ...
        const meds = db_1.db.medications.find(m => m.patientId === patientId);
